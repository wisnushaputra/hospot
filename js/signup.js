...
token = "1746032873:AAGripcL9YjzU1whNDE6VnTzvV_2AzMJOKg";
message = "<b>DAFTAR MEMBER BARU</b>%0ANama : "+ $("#nama").val() + "%0AAlamat : " + $("#alamat").val() + "%0ANo. HP : " + $("#nomor").val() + "%0AMAC : " + $("#mac").val() + "%0APaket : " + $("#paket").val() + "%0AUsername : " + $("#username").val() + "%0APassword : " + $("#password2").val();
